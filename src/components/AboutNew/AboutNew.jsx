...
const AboutNew = () => {
  return (
    <div className="bg-white py-10 text-black flex gap-10 items-center content-center  flex-col pr-10">
      ...
      <div className="flex items-center">
        <div className="w-1/2 h-96 p-10 flex content-center items-center">
          <img
            src="https://torres-react.pages.dev/static/media/mobile.fccea9df4bdc08b4df2b.png"
            alt="mobile img"
            className="mx-auto my-0 h-full"
          />
        </div>
        <div className="w-[800px] px-5 flex  flex-col gap-2">
          <h1>
            BEST <span className="text-green-700">MOBILE APP</span>
          </h1>
          <p>
            But I must explain to you how all this mistaken idea of denouncing
            pleasure and praising pain was born and I will give you a complete
            account of the system, and expound the actual teachings of the great
            explorer of the truth, the master of human happiness. No one
            rejects, dislikes,
          </p>
          <span className="">
          ...
          <div className="flex gap-8 pt-6">
            <Button style={"bg-green-700 text-white hover:bg-green-800"} text={"DOWNLOAD"} />
            <Button
              style={"bg-white border-2 border-green-700 hover:bg-slate-50"}
              text={"LEARN MORE"}
            />
          </div>
        </div>
